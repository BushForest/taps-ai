...
export default async function SessionPayWholePage(props: { params: Promise<{ sessionId: string }> }) {
  ...
  return (
    <SessionShell publicToken={publicToken} activeNav="split" tableLabel={tableLabel}>
      {!summary.access.publicAccessAllowed ? (
        ...
        <PayTab publicToken={publicToken} initialSummary={summary} initialMode="whole" />
      )}
    </SessionShell>
  );
}
